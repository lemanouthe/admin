# Generated by Django 2.2.7 on 2019-11-09 10:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('taille', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=10, null=True), default=adminapp.models.default_thing, size=None)),
                ('family', django.contrib.postgres.fields.jsonb.JSONField()),
                ('prix', django.contrib.postgres.fields.ranges.IntegerRangeField()),
                ('date_add', models.DateTimeField(auto_now_add=True)),
                ('date_upd', models.DateTimeField(auto_now=True)),
                ('status', models.BooleanField(default=False)),
